...
class RusprofileParser(models.Model):
    ...
    use_key_words = models.BooleanField(blank=True, default=True, verbose_name='Использовать ключевые слова')
    key_words = models.TextField(verbose_name='Ключевые слова для поиска', default='')
    number_of_coincidences = models.IntegerField(verbose_name='Количество совпадений', default=0)
